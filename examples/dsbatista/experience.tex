  ...
  \cventry
    ...
    {Feb 2024 - Present} % Date(s)
	{
      \begin{cvitems} % Description(s) of tasks/responsibilities
		\item {Membert of the open-source team developing and maintaining Haystack, an open-source LLM orchestration framework used by thousands of developers globally.
}
      \end{cvitems}
    }
