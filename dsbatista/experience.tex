...
%---------------------------------------------------------
  ...
  \cventry
    ...
    {Veeva Systems GmbH} % Organization
    {Berlin, Germany} % Location
    {Mar 2023 - Jan 2024} % Date(s)
	{
      \begin{cvitems} % Description(s) of tasks/responsibilities
		...
		\item {Developed a model to improve a newsfeed by identifying relevant news articles. I overcame challenges like an imbalanced dataset and limited text access using contrastive learning with pre-trained sentence-transformers. I led the end-to-end process, from data collection and annotation management to model development and production deployment.}
      \end{cvitems}
    }
